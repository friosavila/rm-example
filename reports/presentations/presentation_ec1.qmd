...
- [The Sith Empire]{.sith}
  - Seekers of power
  - Masters of the dark side

> [Do. Or do not. There is no try.]{.force-quote}
> -- Yoda


# The Dawn of Civilization

## From Dinosaurs to Empires

:::{.timeline}
- Mesozoic Era: Age of Dinosaurs
- Paleolithic Period: Early Human Ancestors
- Neolithic Period: Rise of Agriculture
:::

- The mighty [T-Rex]{.hieroglyph} ruled the land
  - Mammoths roamed the icy plains
    - Aztec eagles soared over temples

:::{.artifact}
**The Rosetta Stone**: Key to deciphering Egyptian hieroglyphs
:::

> [The past is never dead. It's not even past.]{.ancient-quote}
> -- William Faulkner
...
:::{.quest}
**Main Quest**: Retrieve the [Sword of Destiny]{.spell} from the Dragon's Lair
:::

- Gather your party
- Stock up on potions
- Prepare for [Fireball]{.spell} encounters
...
> "Beware the [Ancient Red Dragon]{.boss-text} that guards the treasure!"

# Welcome to My Anime-Style Presentation!

:::{.speech-bubble}
This presentation is going to be awesome!
:::

- Point 1
- Point 2
- [Highlighted point]{.anime-highlight}

[Click me!]{.anime-button}
...
:::{.medieval-initial}
Welcome to our journey through the realm of econometrics, where we shall uncover the mysteries of economic data.
:::
...
:::{.theorem}
In the simplest form, we express our model as:

:::{.econometric-model}
Y = β₀ + β₁X + ε
:::

Where Y is our dependent variable, X is our independent variable, and ε represents the error term.
:::
